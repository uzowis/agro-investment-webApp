...
<!--market updates updates-->
	<?php
	$query_row = mysqli_query($db, "SELECT * FROM deposits WHERE user_id= $id");
	$rows = mysqli_num_rows($query_row);

	$query_row2 = mysqli_query($db, "SELECT * FROM withdrawals WHERE user_id=$id AND status= 'Approved'");
	$rows2 = mysqli_num_rows($query_row2);

	$query_row3= mysqli_query($db, "SELECT * FROM withdrawals WHERE user_id=$id AND status= 'Pending'");
	$rows3 = mysqli_num_rows($query_row3);
	 ...
	 <div class="market-updates">
			<div class="col-md-4 market-update-gd">
				<div class="market-update-block clr-block-1">
					...
					<div class="col-md-8 market-update-left">
						<h3><?php if($rows >0 ){echo $rows;}else{ echo "0";}?></h3>
						<h4>Investments</h4>
						<p>Click to view investments</p>
					</div>
					</a>
			...
			<div class="col-md-4 market-update-gd">
				<div class="market-update-block clr-block-2">
					<a href="cashout.php">
				 <div class="col-md-8 market-update-left">
					<h3><?php if($rows2 >0 ){echo $rows2;}else{ echo "0";}?></h3>
					<h4>Withdrawal</h4>
					<p>Click to view withdrawals</p>
				  </div>
				</a>
					<div class="col-md-4 market-update-right">
						<i class="fa fa-eye"> </i>
			...
			<div class="col-md-4 market-update-gd">
				<div class="market-update-block clr-block-3">
					<a href="cashout.php">
					<div class="col-md-8 market-update-left">
						<h3><?php if($rows3 >0 ){echo $rows3;}else{ echo "0";}?></h3>
						<h4>Due Cashout</h4>
						<p>Click to view due cashout</p>
	...
	<div class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover" style="height: 20em;">
                                  <thead>
                                    <tr>
                                      <th>#</th>
                                      <th>Project</th>
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td><a href="plan.php"><span class="label label-success">Invest</span></a></td>
		...
		<div class="col-md-6 chart-layer1-right"> 
			...
			<div class="malorm-bottom">
				...
				<p><b>Email:</b><b> <?php echo $result['email']; ?></b></p>
				<p><b>Phone Number:</b><b>  <?php echo $result['phone']; ?></b></p>
				<!--<p><b>Referal Code:</b><b> 402794629</b></p>-->
				&nbsp;
